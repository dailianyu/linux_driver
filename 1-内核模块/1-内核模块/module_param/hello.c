...
static int array[6]= {-1, 0,1,2,3,4};
static int arr_argc = 0;

module_param (myshort, short, 0660); /* other user don't have writable permit, longer*/
MODULE_PARM_DESC (myshort, "A short integer");

module_param (myint, int, 0660); 
MODULE_PARM_DESC (myint, "An integer");

module_param (mylong, long, 0660); 
MODULE_PARM_DESC (mylong, "A long integer");

module_param (mystring, charp, 0660);
MODULE_PARM_DESC (mystring, "A character string");

module_param_array (array, int, &arr_argc, 0660);
